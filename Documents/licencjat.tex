...
\section{Aplikacja}
todo
\chapter{Porównanie z innymi produktami}
\section{Inne produkty}
todo
\section{Różnice}
todo
...
\subsection{ExtGWT - Spring}
todo
\subsection{ExtGWT - Hibernate}
todo
