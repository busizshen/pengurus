...
omówioną we wcześniejszych rozdziałach tej pracy. Powstanie tej hierarchii to także zasługa Jakuba, 
...
\paragraph{Pozostałe}
Oczywiście nie wszystko co zostało wykonane w projekcie podlega klasyfikacji do powyższych kategorii. Poniżej znajdują się te części pracy, 
