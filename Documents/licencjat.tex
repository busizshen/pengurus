...
\chapter{Rozwiązania}
\section{Spring}
zalety springa i alternatywy (tu coś znajdę)
...
\section{Zalety i wady (problemy) użytych narzędzi}
\subsection{Zalety}
Było bardzo fajnie, szło gładko + to, czego nie było w temacie Rozwiązania.
