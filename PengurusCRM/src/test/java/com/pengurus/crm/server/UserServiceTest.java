...
public class UserServiceTest {
    ...
    public void passwordEncodingWhileCreating() throws ServiceException,
        ...
        Assert.isTrue(encoder.encodePassword("pass",
                saltSource.getSalt(UserUtils.toUser(userDTO).toUserDetails()))
                .equals(userDTO.getPassword()));
    }

    @Test
    public void passwordEncodingWhileUpdating() throws ServiceException,
            UsernameExistsException { // given
        ...
        Assert.isTrue(passwordEncoder.encodePassword(
                "updated",
                saltSource
                        .getSalt(UserUtils.toUser(newUserDTO).toUserDetails()))
                .equals(userDTO.getPassword()));
    }
