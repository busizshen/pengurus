...
public interface QuoteServiceAsync {
	...
	public Set<QuoteDTO> getQuoteBySupervisorId(Long id, AsyncCallback<QuoteDTO> callback);
	public Set<QuoteDTO> getQuoteByClientId(Long id, AsyncCallback<QuoteDTO> callback);
}
